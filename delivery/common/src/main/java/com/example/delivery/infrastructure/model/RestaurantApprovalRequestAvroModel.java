...
public class RestaurantApprovalRequestAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.example.delivery.infrastructure.model.RestaurantApprovalRequestAvroModel.Builder newBuilder() {
    return new com.example.delivery.infrastructure.model.RestaurantApprovalRequestAvroModel.Builder();
  }
   ...
   * @return A new RestaurantApprovalRequestAvroModel RecordBuilder
   */
  public static com.example.delivery.infrastructure.model.RestaurantApprovalRequestAvroModel.Builder newBuilder(com.example.delivery.infrastructure.model.RestaurantApprovalRequestAvroModel.Builder other) {
    if (other == null) {
      return new com.example.delivery.infrastructure.model.RestaurantApprovalRequestAvroModel.Builder();
    } else {
      return new com.example.delivery.infrastructure.model.RestaurantApprovalRequestAvroModel.Builder(other);
    }
  }
   ...
   * @return A new RestaurantApprovalRequestAvroModel RecordBuilder
   */
  public static com.example.delivery.infrastructure.model.RestaurantApprovalRequestAvroModel.Builder newBuilder(com.example.delivery.infrastructure.model.RestaurantApprovalRequestAvroModel other) {
    if (other == null) {
      return new com.example.delivery.infrastructure.model.RestaurantApprovalRequestAvroModel.Builder();
    } else {
      return new com.example.delivery.infrastructure.model.RestaurantApprovalRequestAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RestaurantApprovalRequestAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.delivery.infrastructure.model.RestaurantApprovalRequestAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.delivery.infrastructure.model.RestaurantApprovalRequestAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.orderId)) {
        this.orderId = data().deepCopy(fields()[0].schema(), other.orderId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.delivery.infrastructure.model.RestaurantApprovalRequestAvroModel.Builder setOrderId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.delivery.infrastructure.model.RestaurantApprovalRequestAvroModel.Builder clearOrderId() {
      orderId = null;
