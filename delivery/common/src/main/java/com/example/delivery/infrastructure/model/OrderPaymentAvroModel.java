...
public class OrderPaymentAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<OrderPaymentAvroModel> ENCODER =
      new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<OrderPaymentAvroModel> DECODER =
   ...
   */
  public static BinaryMessageEncoder<OrderPaymentAvroModel> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<OrderPaymentAvroModel> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<OrderPaymentAvroModel> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this OrderPaymentAvroModel to a ByteBuffer.
  ...
  /**
   * Deserializes a OrderPaymentAvroModel from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a OrderPaymentAvroModel instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static OrderPaymentAvroModel fromByteBuffer(
   ...
   */
  public OrderPaymentAvroModel(java.util.UUID id, java.util.UUID orderId, java.util.UUID sagaId, java.lang.Long createdAt, java.lang.String outboxStatus, java.math.BigDecimal totalPrice, java.lang.Long userId) {
    this.id = id;
  ...
  /**
   * Creates a new OrderPaymentAvroModel RecordBuilder.
   * @return A new OrderPaymentAvroModel RecordBuilder
   */
  public static com.example.delivery.infrastructure.model.OrderPaymentAvroModel.Builder newBuilder() {
    return new com.example.delivery.infrastructure.model.OrderPaymentAvroModel.Builder();
  }

  /**
   * Creates a new OrderPaymentAvroModel RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new OrderPaymentAvroModel RecordBuilder
   */
  public static com.example.delivery.infrastructure.model.OrderPaymentAvroModel.Builder newBuilder(com.example.delivery.infrastructure.model.OrderPaymentAvroModel.Builder other) {
    if (other == null) {
      return new com.example.delivery.infrastructure.model.OrderPaymentAvroModel.Builder();
    } else {
      return new com.example.delivery.infrastructure.model.OrderPaymentAvroModel.Builder(other);
    }
  }

  /**
   * Creates a new OrderPaymentAvroModel RecordBuilder by copying an existing OrderPaymentAvroModel instance.
   * @param other The existing instance to copy.
   * @return A new OrderPaymentAvroModel RecordBuilder
   */
  public static com.example.delivery.infrastructure.model.OrderPaymentAvroModel.Builder newBuilder(com.example.delivery.infrastructure.model.OrderPaymentAvroModel other) {
    if (other == null) {
      return new com.example.delivery.infrastructure.model.OrderPaymentAvroModel.Builder();
    } else {
      return new com.example.delivery.infrastructure.model.OrderPaymentAvroModel.Builder(other);
  ...
  /**
   * RecordBuilder for OrderPaymentAvroModel instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderPaymentAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.delivery.infrastructure.model.OrderPaymentAvroModel.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing OrderPaymentAvroModel instance
     * @param other The existing instance to copy.
     */
    private Builder(com.example.delivery.infrastructure.model.OrderPaymentAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.delivery.infrastructure.model.OrderPaymentAvroModel.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.delivery.infrastructure.model.OrderPaymentAvroModel.Builder clearId() {
      id = null;
    ...
    public OrderPaymentAvroModel build() {
      try {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<OrderPaymentAvroModel>
    WRITER$ = (org.apache.avro.io.DatumWriter<OrderPaymentAvroModel>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<OrderPaymentAvroModel>
    READER$ = (org.apache.avro.io.DatumReader<OrderPaymentAvroModel>)MODEL$.createDatumReader(SCHEMA$);
